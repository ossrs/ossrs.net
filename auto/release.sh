...
echo ""
echo "Check at:"
echo "    https://cr.console.aliyun.com/repository/cn-hangzhou/ossrs/web/images"
echo "Apply by:"
echo "    kubectl set image deploy/web-deploy web=registry.cn-hangzhou.aliyuncs.com/ossrs/web:$SRS_TAG"
